...
namespace CropCalculator.Primitives.Geometry
{
    /// <summary>
    /// Classifies two <see cref="IRange"/> and checks for intersection. Magic.
    /// </summary>
    class IntersectionHelper
    {
        ...
        {
            return VectorHelper.Pythagorean(
                circle1.GetCenter(),
                circle2.GetCenter()
        ...
        {
            float o1 = Orientation(
                line1.GetStart(),
                line2.GetStart(),
                line1.GetEnd()
            );
            float o2 = Orientation(
                line1.GetStart(),
                line2.GetStart(),
                line2.GetEnd()
            );
            float o3 = Orientation(
                line1.GetEnd(),
                line2.GetEnd(),
                line1.GetStart()
            );
            float o4 = Orientation(
                line1.GetEnd(),
                line2.GetEnd(),
                line2.GetStart()
            );
