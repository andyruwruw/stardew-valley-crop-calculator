...
namespace CropCalculator.Primitives.Geometry
{
    ...
    internal class Orientation
    {
        ...
        /// <summary>
        /// Instantiates a new orientation tracker.
        /// </summary>
        /// <param name="radius">Radius of object.</param>
        /// <param name="longitude">Longitude value of orientation.</param>
        /// <param name="latitude">Latitude value of orientation.</param>
        public Orientation(
            float radius,
            float longitude = 0,
            float latitude = 0
