...
using CropCalculator.Primitives.Geometry;
using Microsoft.Xna.Framework;

namespace CropCalculator.Primitives
{
    /// <summary>
    ...
    internal class Rectangle : IRange
    {
        ...
        /// </summary>
        /// <param name="anchor">Anchor of the rectangle, or top left.</param>
        ...
        public Microsoft.Xna.Framework.Rectangle GetRawXnaRectangle()
        {
            return new Microsoft.Xna.Framework.Rectangle(
                (int)(this._anchor.X * RenderingHelper.TileScale() + RenderingHelper.AdjustedScreen.Margin.Width()),
                (int)(this._anchor.Y * RenderingHelper.TileScale() + RenderingHelper.AdjustedScreen.Margin.Height()),
                (int)(this._width * RenderingHelper.TileScale()),
                (int)(this._height * RenderingHelper.TileScale())
            );
        }
        ...
        {
            return IntersectionHelper.IsIntersecting(
                this,
                other
            );
        }
